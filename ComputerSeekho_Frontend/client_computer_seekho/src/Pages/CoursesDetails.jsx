    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 px-6 py-12">
      <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-2xl rounded-3xl shadow-2xl px-10 py-14 border border-white/40">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {/* Duration */}
          <div className="flex items-center justify-between bg-gray-50 rounded-xl px-6 py-4 shadow-sm border-l-4 border-blue-500 hover:shadow-lg hover:-translate-y-1 transition">
          ...
          {/* Fees */}
          <div className="flex items-center justify-between bg-gray-50 rounded-xl px-6 py-4 shadow-sm border-l-4 border-green-500 hover:shadow-lg hover:-translate-y-1 transition">
            <span className="flex items-center gap-2 font-semibold text-gray-700">
          ...
          {/* Age Group */}
          <div className="flex items-center justify-between bg-gray-50 rounded-xl px-6 py-4 shadow-sm border-l-4 border-purple-500 hover:shadow-lg hover:-translate-y-1 transition">
            <span className="flex items-center gap-2 font-semibold text-gray-700">
          ...
          {/* Status */}
          <div className="flex items-center justify-between bg-gray-50 rounded-xl px-6 py-4 shadow-sm border-l-4 border-yellow-500 hover:shadow-lg hover:-translate-y-1 transition">
            <span className="flex items-center gap-2 font-semibold text-gray-700">
              <FaCheckCircle className="text-yellow-600" /> Status
            </span>
            <span
              className={`px-4 py-1.5 rounded-full text-sm font-semibold ${course.courseIsActive
